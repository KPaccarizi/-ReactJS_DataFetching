...
function resolve2posix(dir, filename) {
  ...
  return native2posix(dir ? import_path3.default.resolve(posix2native(dir), posix2native(filename)) : import_path3.default.resolve(posix2native(filename)));
}
...
function extendTSConfig(extending, extended) {
  ...
  const relativePath = native2posix(import_path4.default.relative(import_path4.default.dirname(extending.tsconfigFile), import_path4.default.dirname(extended.tsconfigFile)));
...
async function parseFile2(tsconfigFile, ts, options) {
  ...
  const nativeResult = parseJsonConfigFileContent(config, host, import_path6.default.dirname(posixTSConfigFile), void 0, posixTSConfigFile);
